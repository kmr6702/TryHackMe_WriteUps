...
After determining that there was an exposed git repository, I ran ```pip install git-dumper``` so that git-dumper would be installed. 
### 3. Run git-dumper
...
## Tools Used
 ...
 ## Key Takeaways 
  ...
  - When used with the correct tags, nmap can alert if there is an exposed repository 
  - git-dumper can be used to copy a repository into a file
